defmodule Wo.SermonSeriesTest do
  ...
  @valid_attrs %{buy_graphic_url: "some content", description: "some content", graphic_url: "some content", price: "120.5", released_on_string: "4-17-2010", title: "some content"}
  @invalid_attrs %{}
